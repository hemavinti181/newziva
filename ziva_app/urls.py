...
urlpatterns = [
    ...
    path('store_edit/<str:id>/',views.store_edit,name='store_edit'),
    path('item_list',views.item_list,name='item_master'),
    path('item_add',views.item_add,name='item_add'),
    path('item_edit/<str:id>/',views.item_edit,name='item_edit'),
    ...
    path('region_edit/<str:id>/', views.region_edit, name='region_edit'),
    path('region_status_active/<str:id>/',views.region_status_active,name='region_status_active'),
    path('region_status_inactive/<str:id>/',views.region_status_inactive,name='region_status_inactive'),
    ...
    path('region_search',views.region_search,name='region_search'),
